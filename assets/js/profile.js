                            ...
                            <a href="/u/${encodeURIComponent(user.username)}" class="profile-search-item">
                                ...
                                <div class="profile-search-info">
                                    <div style="display: flex; align-items: center; gap: 4px; flex-wrap: wrap;">
                                        ...
                                        ${user.is_premium ? `<img class="cr-premium-gem" src="/img/premium.svg" alt="Premium" title="Premium" style="font-size: 0.78rem;">` : ''}
                                    </div>
...
(() => {
    ...
    // Effetti del nome (lettere che saltano, scintille, braci, bolle).
    const nameEl = document.querySelector('.profile-display-name');
    if (nameEl && window.CripsumNameEffects) {
        window.CripsumNameEffects.apply(nameEl, nameEl.dataset.nameEffect || 'none');
    }
