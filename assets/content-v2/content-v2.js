                ...
                <div class="cw-card-body">
                    <div class="cw-post__head">
                        <a class="cw-user" href="/u/${encodeURIComponent(post.username || '')}">
                            ...
                            <span>
                                <strong>${escapeHtml(post.username || t.user_fallback)}${Number(post.is_premium) === 1 ? ' <span class="premium-badge-icon" title="Premium"><img class="cr-premium-gem" src="/img/premium.svg" alt="Premium"></span>' : ''}</strong>
                    ...
                    ${comments.length ? comments.map((comment) => `
                        <div class="cw-comment">
                            ...
                            <div class="cw-comment__body">
                                <strong>${escapeHtml(comment.username || t.user_fallback)}${Number(comment.is_premium) === 1 ? ' <span class="premium-badge-icon" title="Premium"><img class="cr-premium-gem" src="/img/premium.svg" alt="Premium"></span>' : ''}</strong>
