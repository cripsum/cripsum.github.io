...
try {
    ...
    foreach ($messages as $message) {
        ...
        echo '<a href="../user?id=' . $message['user_id'] . '" class="message-username-link"><span class="message-username">' . htmlspecialchars($message['username']) . ' <img src="/assets/images/'.htmlspecialchars($message['ruolo']).'.png" alt="Role" style="width: 25px; height: 25px; object-fit: cover;" class="role-icon"></span></a>';
