...
try {
    ...
    foreach ($messages as $message) {
        ...
        echo '<a href="../user/' . $message['username'] . '" class="message-username-link"><span class="message-username">' . htmlspecialchars($message['username']) . ' <img src="../img/'.htmlspecialchars($message['ruolo']).'.png" alt="Role" title="' . htmlspecialchars($message['ruolo']) . '" style="width: 25px; height: 25px; object-fit: cover;" class="role-icon"></span></a>';
