...
function gd_get_character_config(int $pid, string $rarity, string $nome, string $role = 'DPS'): array {
    ...
    $special_configs = [
        ...
        145 => [
            'role' => 'DPS',
            'passive_name' => 'Clausola Vessatoria',
            'passive_desc' => 'Gli attacchi base hanno il 40% di probabilità di ridurre la Difesa nemica del 30% per 2 turni.',
            'passive_effect' => ['type' => 'termini_condizioni_passive'],
            'special_name' => 'Firma in Calce',
            'special_desc' => 'Infligge il 180% ATK come danno. Se il nemico è affetto da un debuff, ricarica 1 Energia.',
            'special_effect' => ['type' => 'termini_condizioni_special'],
            'special_cost' => 2,
            'special_cooldown' => 2
        ],
        146 => [
            'role' => 'Sub DPS',
            'passive_name' => 'Urlo delle Ragadi',
            'passive_desc' => 'Aumenta il proprio Attacco del 15% finché i suoi HP rimangono superiori al 70%.',
            'passive_effect' => ['type' => 'speciale_146_passive'],
            'special_name' => 'Attacco dell\'Agonia',
            'special_desc' => 'Infligge il 150% ATK, riduce la Velocità nemica del 25% per 2 turni e applica Sanguinamento (10% HP a turno) per 2 turni.',
            'special_effect' => ['type' => 'speciale_146_special'],
            'special_cost' => 2,
            'special_cooldown' => 2
        ],
        147 => [
            'role' => 'Support',
            'passive_name' => 'Panino d\'Emergenza',
            'passive_desc' => 'Quando un alleato scende sotto il 40% HP, gli fornisce uno Scudo pari al 25% degli HP max di questo personaggio (una volta per match per alleato).',
            'passive_effect' => ['type' => 'speciale_147_passive'],
            'special_name' => 'Ce lo facciamo un cazzo di panino o no?',
            'special_desc' => 'Applica uno Scudo pari al 30% degli HP max di questo personaggio a tutti i membri del team e aumenta la loro Difesa del 30% per 2 turni.',
            'special_effect' => ['type' => 'speciale_147_special'],
            'special_cost' => 2,
            'special_cooldown' => 2
        ],
        148 => [
            'role' => 'Debuffer',
            'passive_name' => 'Lancio della Sardina',
            'passive_desc' => 'All\'inizio del suo turno, riduce la Difesa di tutti i nemici attivi del 15% per 1 turno.',
            'passive_effect' => ['type' => 'speciale_148_passive'],
            'special_name' => 'Yeah Yeah... Special move or something',
            'special_desc' => 'Infligge il 130% ATK, riduce la Difesa nemica del 30% per 2 turni e applica Veleno (12% HP a turno) per 2 turni.',
            'special_effect' => ['type' => 'speciale_148_special'],
            'special_cost' => 2,
            'special_cooldown' => 2
        ],
        149 => [
            'role' => 'Buffer',
            'passive_name' => 'Screaming at Comments',
            'passive_desc' => 'Finché è in vita, aumenta l\'Attacco di tutti gli alleati del 10%.',
            'passive_effect' => ['type' => 'speciale_149_passive'],
            'special_name' => 'Green Screen Rage',
            'special_desc' => 'Aumenta l\'Attacco del personaggio attivo del 40% per 2 turni e gli fornisce 2 Energia.',
            'special_effect' => ['type' => 'speciale_149_special'],
            'special_cost' => 2,
            'special_cooldown' => 2
        ],
        150 => [
            'role' => 'DPS',
            'passive_name' => 'Mogging Brutale',
            'passive_desc' => 'Aumenta il proprio Crit Rate del 25%. Quando realizza un colpo critico, riduce la Difesa del bersaglio del 25% per 2 turni.',
            'passive_effect' => ['type' => 'brutal_mogger_passive'],
            'special_name' => 'Jawline Devastante',
            'special_desc' => 'Infligge il 220% ATK a bersaglio singolo. Se il colpo è critico, infligge il 50% di danni aggiuntivi.',
            'special_effect' => ['type' => 'brutal_mogger_special'],
            'special_cost' => 3,
            'special_cooldown' => 3,
            'ultimate_name' => 'Mewing Divino',
            'ultimate_desc' => 'Sferra un attacco colossale da 350% ATK che ignora il 40% della Difesa nemica. Ricarica il 100% dell\'energia se sconfigge il nemico.',
            'ultimate_effect' => ['type' => 'brutal_mogger_ultimate']
        ],
        151 => [
            'role' => 'Tank',
            'passive_name' => 'Dipendenza da FIFA',
            'passive_desc' => 'Riduce passivamente tutti i danni ricevuti del 20%.',
            'passive_effect' => ['type' => 'segreto_151_passive'],
            'special_name' => 'Puff da 9000 Tiri',
            'special_desc' => 'Attiva Provocazione per 2 turni, ottiene uno Scudo pari al 45% dei suoi HP max e aumenta la propria Difesa del 40% per 2 turni.',
            'special_effect' => ['type' => 'segreto_151_special'],
            'special_cost' => 2,
            'special_cooldown' => 2,
            'ultimate_name' => 'Chillata Droga e Fumo',
            'ultimate_desc' => 'Attiva Provocazione per 3 turni, ottiene uno Scudo pari al 75% dei suoi HP max e fornisce uno Scudo pari al 35% dei suoi HP max a tutti gli alleati.',
            'ultimate_effect' => ['type' => 'segreto_151_ultimate']
        ],
        152 => [
            'role' => 'Support',
            'passive_name' => 'Kai in Guardia',
            'passive_desc' => 'Tutto il team subisce il 15% di danni in meno finché questo personaggio è in vita.',
            'passive_effect' => ['type' => 'segreto_152_passive'],
            'special_name' => 'Passeggiata a Ferrara',
            'special_desc' => 'Fornisce a tutto il team uno Scudo pari al 35% degli HP max di questo personaggio e rimuove tutti i debuff da tutti gli alleati.',
            'special_effect' => ['type' => 'segreto_152_special'],
            'special_cost' => 2,
            'special_cooldown' => 2,
            'ultimate_name' => 'Fedeltà di Kai',
        ...
        153 => [
            ...
            'passive_effect' => ['type' => 'poppy_passive'],
            'special_name' => 'Richiamo del bombo',
            'special_desc' => 'Infligge il 180% ATK come danno, Stordisce il bersaglio per 1 turno e applica Sanguinamento (12% HP a turno) per 2 turni.',
            'special_effect' => ['type' => 'poppy_special'],
            'special_cost' => 2,
            'special_cooldown' => 2,
        ...
        154 => [
            ...
            'passive_effect' => ['type' => 'lacly_passive'],
            'special_name' => 'Kurumi: Zafkiel',
            'special_desc' => 'Infligge il 240% ATK come danno a bersaglio singolo. Ignora lo Scudo attivo sul bersaglio.',
            'special_effect' => ['type' => 'lacly_special'],
            'special_cost' => 2,
            'special_cooldown' => 2,
            'ultimate_name' => 'Yud Bet',
        ...
        155 => [
            ...
            'passive_effect' => ['type' => 'low_tier_god_passive'],
            'special_name' => 'Your Life is Nothing',
            'special_desc' => 'Infligge il 230% ATK come danno elettrico a bersaglio singolo e Stordisce il nemico per 1 turno.',
            'special_effect' => ['type' => 'low_tier_god_special'],
            'special_cost' => 2,
            'special_cooldown' => 2,
            'ultimate_name' => 'Lightning Bolt',
            'ultimate_desc' => 'Sferra un fulmine apocalittico da 360% ATK a bersaglio singolo che ignora tutti gli scudi e ha il 40% di probabilità di stordire per 2 turni.',
            'ultimate_effect' => ['type' => 'low_tier_god_ultimate']
        ],
    ];
