...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/profile-editor.css?v=7.1.0">
    ...
    <script src="/assets/js/profile-editor/components.js?v=7.1.0" defer></script>
    <script src="/assets/js/profile-editor/items.js?v=7.1.0" defer></script>
    <script src="/assets/js/profile-editor/editor.js?v=7.1.0" defer></script>
</head>
