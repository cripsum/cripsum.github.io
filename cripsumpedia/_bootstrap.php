...
function cp_translations(string $lang): array
{
    $dict = [
        'it' => [
            'home' => 'Home',
            'pedia' => 'Cripsumpedia',
            'subtitle' => 'Archivio lore, personaggi, eventi e meme del multiverso Cripsum.',
            'search' => 'Cerca lore',
            'search_placeholder' => 'Cerca persone, eventi, meme, tag, alias, citazioni...',
            'people' => 'Persone',
            'events' => 'Eventi',
            'memes' => 'Meme',
            'person' => 'Persona',
            'event' => 'Evento',
            'meme' => 'Meme',
            'latest' => 'Ultimi elementi',
            'trending' => 'Trending',
            'popular' => 'Popolari',
            'event_day' => 'Evento del giorno',
            'random_quote' => 'Citazione lore',
            'open' => 'Apri',
            'read' => 'Leggi voce',
            'admin' => 'Admin lore',
            ...
            'language_en' => 'Inglese',
            'empty' => 'Qui non c\'e ancora lore. Strano, ma risolvibile.',
        ],
        'en' => [
            'home' => 'Home',
            'pedia' => 'Cripsumpedia',
            'subtitle' => 'Lore archive for people, events and memes from the Cripsum universe.',
            'search' => 'Search lore',
            'search_placeholder' => 'Search people, events, memes, tags, aliases, quotes...',
            'people' => 'People',
            'events' => 'Events',
            'memes' => 'Memes',
            'person' => 'Person',
            ...
            'language_it' => 'Italian',
            'language_en' => 'English',
            'empty' => 'No lore here yet. Weird, but fixable.',
        ],
    ];
...
?>
    ...
    <link rel="stylesheet" href="/cripsumpedia/cripsumpedia.css?v=2.1">
    <script>
    ...
    <script src="/cripsumpedia/cripsumpedia.js?v=2.1" defer></script>
<?php
}
