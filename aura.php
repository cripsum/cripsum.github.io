...
<body>
    ...
    <style>
        ...
        @keyframes zigzag {
            ...
            50% {
                transform: translateX(-30px) translateY(-60px) rotate(-45deg);
            }

            75% {
                transform: translateX(80px) translateY(-20px) rotate(90deg);
            }
        ...
        @keyframes wobble {
            ...
            15% {
                transform: translateX(-25px) skew(-15deg, 5deg);
            }

            30% {
                transform: translateX(20px) skew(10deg, -5deg);
            }

            45% {
                transform: translateX(-15px) skew(-10deg, 3deg);
            }

            60% {
                transform: translateX(10px) skew(5deg, -3deg);
            }

            75% {
                transform: translateX(-5px) skew(-5deg, 2deg);
            }
        ...
        @keyframes fly {
            ...
            20% {
                transform: translate(100px, -50px) rotate(72deg);
            }
            ...
            60% {
                transform: translate(120px, 30px) rotate(216deg);
            }

            80% {
                transform: translate(-60px, 80px) rotate(288deg);
            }
        ...
        @keyframes spiral {
            ...
            50% {
                transform: translate(0, 100px) rotate(180deg) scale(1.5);
            }
        ...
        @keyframes flip {
            ...
            50% {
                transform: perspective(400px) translateZ(150px) rotateY(190deg) scale(1.5);
            }
        ...
        @keyframes randomPath1 {
            ...
            15% {
                transform: translate(calc(80vw - 130px), 20vh) rotate(54deg);
            }

            30% {
                transform: translate(calc(70vw - 130px), calc(70vh - 130px)) rotate(108deg);
            }

            45% {
                transform: translate(20vw, calc(80vh - 130px)) rotate(162deg);
            }

            60% {
                transform: translate(5vw, 50vh) rotate(216deg);
            }

            75% {
                transform: translate(calc(60vw - 130px), 30vh) rotate(270deg);
            }

            90% {
                transform: translate(calc(40vw - 130px), calc(60vh - 130px)) rotate(324deg);
            }
        ...
        @keyframes randomPath2 {
            0% {
                transform: translate(calc(90vw - 170px), calc(80vh - 170px)) rotate(0deg) scale(1);
            }

            20% {
                transform: translate(30vw, 10vh) rotate(72deg) scale(1.3);
            }

            40% {
                transform: translate(10vw, calc(60vh - 170px)) rotate(144deg) scale(0.7);
            }

            60% {
                transform: translate(calc(75vw - 170px), calc(40vh - 170px)) rotate(216deg) scale(1.1);
            }

            80% {
                transform: translate(calc(50vw - 170px), calc(85vh - 170px)) rotate(288deg) scale(0.9);
            }

            100% {
                transform: translate(calc(90vw - 170px), calc(80vh - 170px)) rotate(360deg) scale(1);
            }
        }
        ...
        @keyframes dvdBounce {
            ...
            12.5% {
                transform: translate(calc(50vw - 55px), calc(25vh - 27.5px)) rotate(45deg) scale(1.1);
                filter: hue-rotate(45deg) brightness(1.2);
            }

            25% {
                transform: translate(calc(100vw - 110px), calc(50vh - 55px)) rotate(90deg) scale(0.9);
                filter: hue-rotate(90deg) brightness(0.8);
            }

            37.5% {
                transform: translate(calc(75vw - 82.5px), calc(75vh - 82.5px)) rotate(135deg) scale(1.2);
                filter: hue-rotate(135deg) brightness(1.1);
            }

            50% {
                transform: translate(calc(100vw - 110px), calc(100vh - 110px)) rotate(180deg) scale(1);
                filter: hue-rotate(180deg) brightness(1.3);
            }

            62.5% {
                transform: translate(calc(50vw - 55px), calc(100vh - 110px)) rotate(225deg) scale(0.8);
                filter: hue-rotate(225deg) brightness(0.9);
            }

            75% {
                transform: translate(0px, calc(100vh - 110px)) rotate(270deg) scale(1.1);
                filter: hue-rotate(270deg) brightness(1.1);
            }

            87.5% {
                transform: translate(calc(25vw - 27.5px), calc(50vh - 55px)) rotate(315deg) scale(0.95);
