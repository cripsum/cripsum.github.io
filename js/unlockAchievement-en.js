(() => {
    ...
    function normalizeAchievement(data, id) {
        ...
        return {
            id,
            nome: safeText(source?.nome_en ?? source?.name, 'Achievement sbloccato'),
            descrizione: safeText(source?.descrizione_en ?? source?.description, 'Hai ottenuto un nuovo achievement.'),
