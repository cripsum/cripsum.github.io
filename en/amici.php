...
<body class="static-page" data-logged-in="1" data-csrf="<?php echo $csrfToken; ?>">
    ...
    <script src="/assets/social/social-ui.js?v=1.8" defer></script>
    <script src="/assets/social/user-card.js?v=2.8" defer></script>
