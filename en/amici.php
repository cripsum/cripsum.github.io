...
<head>
    ...
    <link class="static-css" rel="stylesheet" href="/assets/static/static.css?v=1.2-static">
     <link rel="stylesheet" href="/assets/social/social.css?v=1.3">
</head>
...
<body class="static-page" data-csrf="<?php echo $csrfToken; ?>">
    ...
    <script src="/assets/social/social-ui.js?v=1.2" defer></script>
    <script src="/assets/social/user-card.js?v=1.4" defer></script>
