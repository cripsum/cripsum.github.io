...
<head>
    ...
    <link class="profile-css-file" rel="stylesheet" href="/assets/css/profile.css?v=4.4.8">
    <preconnect href="https://fonts.googleapis.com">
        <preconnect href="https://fonts.gstatic.com" crossorigin>
            ...
            <script src="/assets/js/profile.js?v=4.4.8" defer></script>
            <script src="/assets/js/edit-profile-en.js?v=4.4.8" defer></script>
</head>
