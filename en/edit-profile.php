...
$linkStyle = profile_allowed_value((string)($profile['profile_link_style'] ?? 'glass'), ['glass', 'solid', 'outline', 'neon', 'minimal', 'gradient'], 'glass');
...
<head>
    ...
    <link class="profile-css-file" rel="stylesheet" href="/assets/css/profile.css?v=4.8.8">
    <link rel="stylesheet" href="/assets/css/editor-premium.css?v=4.8.8">
    ...
    <script src="/assets/js/edit-profile-en.js?v=4.8.8" defer></script>
</head>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="design">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid three">
                                ...
                                <label class="profile-field"><span>Layout</span><select name="profile_layout" id="layoutInput"><?php $currentLayout = ['compact' => 'left-tabs', 'showcase' => 'center-split', 'clean' => 'stacked'][$profile['profile_layout'] ?? 'standard'] ?? ($profile['profile_layout'] ?? 'standard'); foreach (['standard' => 'Standard default', 'left-tabs' => 'Profile left, tabs right', 'center-split' => 'Profile center, tabs on sides', 'stacked' => 'Centered column'] as $value => $label): ?><option value="<?php echo $value; ?>" <?php echo $currentLayout === $value ? 'selected' : ''; ?>><?php echo $label; ?></option><?php endforeach; ?></select></label>
                                ...
                                <label class="profile-field"><span>Link style</span><select name="profile_link_style" id="linkStyleInput"><?php foreach (['glass' => 'Glass', 'solid' => 'Solid', 'outline' => 'Outline', 'neon' => 'Neon', 'minimal' => 'Minimal', 'gradient' => 'Gradient'] as $value => $label): ?><option value="<?php echo $value; ?>" <?php echo $linkStyle === $value ? 'selected' : ''; ?>><?php echo $label; ?></option><?php endforeach; ?></select></label>
