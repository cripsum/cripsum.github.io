...
<head>
    ...
    <link class="profile-css-file" rel="stylesheet" href="/assets/css/profile.css?v=4.8.9">
    <link rel="stylesheet" href="/assets/css/editor-premium.css?v=4.8.9">
    ...
    <script src="/assets/js/edit-profile-en.js?v=4.8.9" defer></script>
</head>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="design">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid three">
                                ...
                                <label class="profile-field"><span>Layout</span><select name="profile_layout" id="layoutInput"><?php $currentLayout = ['left-tabs' => 'compact', 'right-tabs' => 'showcase', 'stacked' => 'clean', 'center-split' => 'showcase'][$profile['profile_layout'] ?? 'standard'] ?? ($profile['profile_layout'] ?? 'standard'); foreach (['standard' => 'Standard default', 'compact' => 'Profile left, tabs right', 'showcase' => 'Profile right, tabs left', 'clean' => 'Centered column'] as $value => $label): ?><option value="<?php echo $value; ?>" <?php echo $currentLayout === $value ? 'selected' : ''; ?>><?php echo $label; ?></option><?php endforeach; ?></select></label>
