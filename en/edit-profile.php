...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/profile.css?v=3.9.5">
    ...
    <script src="/assets/js/profile.js?v=3.9.5" defer></script>
    <script src="/assets/js/edit-profile-en.js?v=3.9.5" defer></script>
</head>
