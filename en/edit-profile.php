...
<head>
    ...
    <script src="/assets/js/edit-profile-en.js?v=5.9.6" defer></script>
</head>
                    ...
                    <div class="plan-option-card is-premium">
                        <div>
                            ...
                            <ul class="plan-features">
                                ...
                                <li><i class="fa-solid fa-check"></i>200,000 points included instantly</li>
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid three">
                                ...
                                <label class="profile-field"><span>Custom Cursor Image <span class="premium-badge-tag"><i class="fa-solid fa-crown"></i> Premium</span></span>
                                    ...
                                    <small style="opacity: 0.7; font-size: 0.75rem; margin-top: 4px; display: block;">PNG, JPG, WEBP, GIF, CUR, ANI. Standard images are resized to 32×32. Animated .ani/GIF files keep their animation.</small>
                                </label>
                            </div>
