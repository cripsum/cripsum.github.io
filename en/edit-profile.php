...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/profile.css?v=4.0.0">
    ...
    <script src="/assets/js/profile.js?v=4.0.0" defer></script>
    <script src="/assets/js/edit-profile-en.js?v=4.0.0" defer></script>
</head>
