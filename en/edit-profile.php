...
$connectDiscordParams = ['return_url' => $_SERVER['REQUEST_URI'] ?? '/en/edit-profile'];
...
<head>
    ...
    <script src="/assets/js/edit-profile-en.js?v=5.13.0" defer></script>
</head>
                    ...
                    <div class="plan-option-card is-premium">
                        <div>
                            ...
                            <ul class="plan-features">
                                ...
                                <li><i class="fa-solid fa-check"></i>25.000 Godos included instantly</li>
                ...
                <div class="editor-sidebar-scroll">
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="identity" data-editor-category="profile">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid two">
                                <label class="profile-field"><span>Profile picture</span><input type="file" name="avatar" id="avatarInput" accept="image/jpeg,image/png,image/webp,image/gif"><small>Max <?php echo profile_format_bytes(profile_effective_upload_limit(($isPremium ? 10 : 2) * 1024 * 1024)); ?>. JPG, PNG, WEBP or GIF.</small></label>
                                <label class="profile-field"><span>Profile banner</span><input type="file" name="banner" id="bannerInput" accept="image/jpeg,image/png,image/webp,image/gif,video/mp4,video/webm"><small>Max <?php echo profile_format_bytes(profile_effective_upload_limit(($isPremium ? 50 : 12) * 1024 * 1024)); ?>. Photo, GIF or video. Changes the page background.</small></label>
                            </div>
