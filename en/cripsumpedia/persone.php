...
<body>
    ...
    <div class="main-content" style="max-width: 1200px; margin: 0 auto; padding: 3rem 2rem 4rem;">
        <div class="page-header" style="margin-bottom: 3rem; padding-bottom: 2rem; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
            <a href="home" class="back-link" style="display: inline-flex; align-items: center; gap: 0.5rem; color: rgba(255, 255, 255, 0.6); text-decoration: none; font-size: 0.95rem; margin-bottom: 1.5rem; transition: all 0.3s ease;">
