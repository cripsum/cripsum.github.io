    ...
    <main class="form-shell form-shell--checkout">
        <section class="form-card form-reveal">
            <div class="form-card__header">
                ...
                <p>Customize your profile with animated layouts, music and badges, instantly get 25.000 Godos, claim 500 bonus Godos every day in Lootboxes, get a 2x Godos boost on all daily and weekly missions, and open your Cripsum Rewind any day you like — not just during the one week it is free for everyone!</p>
            </div>
            ...
            <div class="checkout-layout">
                ...
                <aside class="form-panel checkout-summary">
                    ...
                    <div class="summary-line" id="summaryBadgeLine">
                        <span>Badge Included</span>
                        <strong id="summaryBadgeText" style="color: #eab308;"><i class="fa-solid fa-gem"></i> Premium Badge</strong>
                    </div>
                    <div class="summary-line">
                        <span>Price</span>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function togglePurchaseType(type) {
                ...
                if (type === 'self') {
                    ...
                    if (summaryBadgeText) {
                        summaryBadgeText.innerHTML = '<i class="fa-solid fa-gem"></i> Premium Badge';
                    }
                } else {
