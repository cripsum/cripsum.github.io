            ...
            <div class="gl-sp-main gl-generator">
                ...
                <div class="gl-sp-controls">
                    ...
                    <div class="gl-sp-mini-actions">
                        <button class="gl-btn gl-btn-ghost" type="button" id="spNextBtn"><i class="fa-solid fa-rotate"></i> Next</button>
                    </div>
                </div>
                ...
                <div class="gl-sp-card" id="smashPassCard">
                    <div class="gl-sp-image-wrap" id="smashPassSwipeArea">
                        ...
                        <div class="gl-sp-swipe-hint" aria-hidden="true"><i class="fa-solid fa-hand-pointer"></i> Swipe right/left</div>
