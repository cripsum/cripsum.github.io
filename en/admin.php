    ...
    <main class="admin-shell">
        <aside class="admin-sidebar" aria-label="Navigazione admin">
            ...
            <nav class="admin-nav" data-admin-nav>
                ...
                <button type="button" data-section="tickets"><i class="fa-solid fa-headset"></i><span>Support Tickets</span></button>
                ...
                <button type="button" data-section="gacha-banner"><i class="fa-solid fa-star"></i><span>Banners</span></button>
                <button type="button" data-section="gacha-categorie"><i class="fa-solid fa-tags"></i><span>Categories</span></button>
                <span class="admin-nav-label">Shop</span>
                <button type="button" data-section="shop-negozio"><i class="fa-solid fa-store"></i><span>Store</span></button>
                <button type="button" data-section="shop-merch"><i class="fa-solid fa-shirt"></i><span>Merch</span></button>
                <button type="button" data-section="shop-gacha"><i class="fa-solid fa-gem"></i><span>Gacha Shop</span></button>
                <button type="button" data-section="shop-download"><i class="fa-solid fa-download"></i><span>Downloads</span></button>
        ...
        <section class="admin-main">
            ...
            <section class="admin-section" id="section-tickets" data-section-panel="tickets">
                <div class="admin-toolbar">
                    <div>
                        <strong>Support Tickets</strong>
                        <small>Manage and reply to support tickets sent by users.</small>
                    </div>
                    <div class="admin-toolbar-actions">
                        <select id="ticketsStatusFilterAdmin" class="admin-input">
                ...
                <div id="ticketsTable" class="admin-table-card"></div>
            </section>
        </section>
    </main>
