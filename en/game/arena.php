...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/game.css?v=3.2-cinematic-cutins-injected">
    <script src="/assets/js/game.js?v=3.2-cinematic-cutins-injected" defer></script>
</head>
    ...
    <main class="game-shell game-arena-shell">
        ...
        <section class="game-panel" id="teamPanel" hidden>
            ...
            <div class="game-inventory-toolbar">
                <input type="search" id="cardSearch" placeholder="Search character...">
                ...
                <select id="sortInventory">
                    <option value="nome">Sort by: Name</option>
                    <option value="hp">Sort by: HP</option>
                    <option value="attack">Sort by: ATK</option>
                    <option value="defense">Sort by: DEF</option>
                    <option value="speed">Sort by: SPD</option>
                </select>
        ...
        <section class="game-arena" id="arenaPanel" hidden>
            ...
            <div class="game-action-bar" id="actionBar" aria-label="Azioni battaglia">
                ...
                <button class="game-move game-move-ultimate" data-battle-action="ultimate" type="button" style="display:none;"><i class="fa-solid fa-bolt"></i><strong>Ultimate</strong></button>
            </div>
