    ...
    <main class="gl-shell gl-quiz-shell">
        <section class="gl-hero gl-hero-small gl-reveal">
            <div class="gl-hero-text">
                ...
                <div class="gl-actions">
                    <a class="gl-btn gl-btn-main" href="#glAnimeQuiz"><i class="fa-solid fa-play"></i> Inizia quiz</a>
        ...
        <?php if ($sharedProfile): ?>
            <section class="gl-shared-result gl-reveal">
                <span class="gl-kicker"><i class="fa-solid fa-share-nodes"></i> Risultato condiviso</span>
                <h2><?php echo gl_safe_html($ogTitle); ?></h2>
                <p><?php echo gl_safe_html($ogDescription); ?></p>
                <div class="gl-actions">
                    <a class="gl-btn gl-btn-main" href="#glAnimeQuiz"><i class="fa-solid fa-play"></i> Fai anche tu il quiz</a>
                    <button class="gl-btn gl-btn-ghost" type="button" data-copy-current-url><i class="fa-solid fa-link"></i> Copia link</button>
                </div>
            </section>
        <?php endif; ?>
        ...
        <section class="gl-quiz-layout gl-reveal" id="glAnimeQuiz">
            <div class="gl-quiz-card" id="glQuizBox">
                ...
                <div class="gl-quiz-nav">
                    <button class="gl-btn gl-btn-ghost" type="button" id="glQuizBack"><i class="fa-solid fa-arrow-left"></i> Indietro</button>
                    <button class="gl-btn gl-btn-main" type="button" id="glQuizNext"><i class="fa-solid fa-arrow-right"></i> Avanti</button>
                </div>
            </div>
        ...
        <section class="gl-result gl-reveal" id="glQuizResult" hidden>
            <div class="gl-result-head">
                <div>
                    <span class="gl-kicker"><i class="fa-solid fa-star"></i> Risultato</span>
            ...
            <div class="gl-result-grid">
                ...
                <div class="gl-result-panel">
                    ...
                    <div class="gl-result-actions">
                        <button class="gl-btn gl-btn-main" type="button" id="glQuizReroll"><i class="fa-solid fa-shuffle"></i> Reroll immagine</button>
                        <button class="gl-btn gl-btn-ghost" type="button" id="glQuizRestart"><i class="fa-solid fa-rotate-left"></i> Rifai quiz</button>
                        <button class="gl-icon-btn" type="button" id="glQuizShare" aria-label="Copia risultato"><i class="fa-solid fa-share-nodes"></i></button>
                    </div>
                </div>
            </div>
        </section>
