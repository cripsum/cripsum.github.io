    ...
    <main class="gl-shell gl-sp-shell">
        <section class="gl-hero gl-hero-small gl-reveal">
            <div class="gl-hero-text">
                <span class="gl-kicker"><i class="fa-solid fa-fire"></i> Smash or Pass</span>
                <h1>Smash or Pass</h1>
            ...
            <div class="gl-sp-main gl-generator">
                ...
                <div class="gl-sp-controls">
                    ...
                    <div class="gl-sp-mini-actions">
                        <button class="gl-btn gl-btn-ghost" type="button" id="spNextBtn"><i class="fa-solid fa-rotate"></i> Prossimo</button>
                    </div>
                </div>

                <div class="gl-sp-card" id="smashPassCard">
                    <div class="gl-sp-image-wrap" id="smashPassSwipeArea">
                        <div class="gl-sp-decision gl-sp-decision-pass" aria-hidden="true"><i class="fa-solid fa-xmark"></i> PASS</div>
                        <div class="gl-sp-decision gl-sp-decision-smash" aria-hidden="true"><i class="fa-solid fa-fire"></i> SMASH</div>
                        <div class="gl-sp-swipe-hint" aria-hidden="true"><i class="fa-solid fa-hand-pointer"></i> Swipe destra/sinistra</div>
                ...
                <div class="gl-sp-choices">
                    <button class="gl-btn gl-btn-pass" type="button" id="spPassBtn"><i class="fa-solid fa-xmark"></i> Pass</button>
                    <button class="gl-btn gl-btn-smash" type="button" id="spSmashBtn"><i class="fa-solid fa-fire"></i> Smash</button>
                </div>
            </div>
