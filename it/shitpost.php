    ...
    <body>
        ...
        <div style="max-width: 1920px; margin: auto; padding-top: 7rem; padding-bottom: 4rem;" class="testobianco">
            ...
            <div class="d-flex justify-content-around image-container" style="max-width: 80%; margin: auto; padding-top: 1%">
                ...
                <div class="fadeup">
                    <br />
                    <p class="fs-6" style="text-align: center; font-weight: normal; max-width: 500px;">Lui è sossio, uno sviluppatore di mod per mario kart. è anche un grande giocatore di wuthering waves e si fa tante seghe, qui lo avete una sua immagine mentre se la chilla con i piedi all'aria</p>
                </div>
            </div>
            <div style="margin: auto; max-width: 80%; text-align: center" class="fadeup">
                <a style="text-align: center">by</a>
