...
if (empty($userId) || (!empty($pending['started_at']) && time() - (int)$pending['started_at'] > 600)) {
    ...
    $_SESSION['login_message'] = 'Sessione di autenticazione scaduta. Effettua nuovamente l’accesso.';
    header('Location: accedi');
    exit();
}
...
<head>
    ...
    <title>Cripsum™ - Conferma Password Google</title>
    ...
    <main class="form-shell form-shell--narrow">
        <section class="form-card form-reveal">
            <div class="form-card__header">
                ...
                <p>Questo account ha una password impostata. Inserisci la password per autorizzare l'accesso con Google.</p>
            </div>
            ...
            <form method="POST" data-form-loading>
                ...
                <label class="form-field">
                    ...
                    <div class="auth-password" style="position: relative;">
                        <input type="password" name="password" autocomplete="current-password" required autofocus data-password-input placeholder="Inserisci la tua password">
                    </div>
                </label>
                ...
                <div class="form-links" style="margin-top: 1rem; text-align: center;">
                    <a href="accedi">Annulla e torna al login</a>
                </div>
            </form>
        </section>
    </main>
