...
<body class="chat-page-body" data-user-id="<?php echo $myUserId; ?>" data-csrf="<?php echo csrf_token(); ?>">
    ...
    <script src="/assets/chat/chat-api.js?v=1.0" defer></script>
    <script src="/assets/chat/chat-state.js?v=1.0" defer></script>
    <script src="/assets/chat/chat-ui.js?v=1.0" defer></script>
    <script src="/assets/chat/chat.js?v=1.6" defer></script>
