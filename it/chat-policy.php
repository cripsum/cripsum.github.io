    ...
    <body>
        ...
        <div style="max-width: 1200px; margin: auto; padding-top: 7rem" class="testobianco">
            <div class="privacy">
                ...
                <p class="fadeup">Accedendo chat, dichiari di aver letto e accettato queste regole. Violazioni possono portare a ban temporanei o permanenti.</p>
                <h4 class="text-center fadeup" style="padding-top: 10px">Rispetta tutti</h4>
                <p class="fadeup">Niente insulti, minacce o linguaggio offensivo.</p>
                ...
                <p class="fadeup">Comportati in modo civile e corretto.</p>
                <h4 class="text-center fadeup" style="padding-top: 10px">Segui le indicazioni dei moderatori</h4>
                <p class="fadeup">Le loro decisioni vanno rispettate.</p>
            </div>
        </div>
