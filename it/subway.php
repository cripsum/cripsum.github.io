...
$ogDescription = 'Gioca a Subway Surfers nel browser con selezione delle mappe, sblocco personaggi e la No-Coin Challenge automatica.';
...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/subway.css?v=1.3">
    <script src="/assets/js/subway/subway.js?v=1.3" defer></script>
</head>
        ...
        <div id="subwayLobby">
            <section class="game-hero game-reveal" style="margin-bottom: 2rem;">
                <div class="game-hero-copy">
                    ...
                    <h1>Subway Portal</h1>
                    <p>Scegli la tua mappa preferita, configura i tuoi controlli personalizzati e preparati a sfidare la No Coin Challenge con rilevamento audio automatico!</p>
                    <div class="game-steps" aria-label="Passaggi della sfida">
                        <span><b>1</b> Attiva la No Coin</span>
                        <span><b>2</b> Scegli la città</span>
            ...
            <section class="game-panel game-reveal" style="margin-top: 2rem;">
                <div class="game-panel-head">
                    <div>
                        ...
                        <p>Le mappe storiche del World Tour caricate al volo da GitHub.</p>
                    </div>
                </div>
                ...
                <div class="subway-grid">
                    ...
                    <div class="subway-map-card" data-map="spacestation">
                        <div class="subway-map-bg" style="background-image: url('https://raw.githubusercontent.com/tavvkkj/therealoness-builds-1/main/game-assets/crosspromo/embedded/ssblast_Image_ss_blast_xpromo_banner_key_art_512x512_02.png');"></div>
                        <div class="subway-map-content">
                            <span class="subway-map-tag tier-3">Spazio</span>
                            <h3>Space Station</h3>
                            <p>Una corsa gravitazionale incredibile tra le stelle e i satelliti.</p>
                        </div>
                    </div>
