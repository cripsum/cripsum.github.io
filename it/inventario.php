                ...
                rarityOrder.forEach((rarity, index) => {
                    ...
                    filteredCharacters.forEach((personaggio) => {
                        ...
                        characterCard.innerHTML = `
                            ...
                            <div class="character-unlock-date">${character ? `Trovato il: ${new Date(character.data).toLocaleDateString()} alle ${new Date(character.data).toLocaleTimeString('it-IT')}` : "Non trovato"}</div>
                        `;
