...
<head>
    ...
    <link rel="stylesheet" href="/assets/inventario/inventario.css?v=2.9.2">
    <script src="/assets/inventario/inventario.js?v=3.0.2" defer></script>
</head>
        ...
        <section class="inv-controls inv-reveal">
            ...
            <div class="inv-custom-select" data-inv-custom-select>
                <select id="rarityFilter" class="inv-select inv-native-select" aria-label="Filtra per rarità" tabindex="-1" aria-hidden="true">
                    ...
                    <option value="segreto_limited">Segreto Limited</option>
                ...
                <div class="inv-select-menu" role="listbox" aria-label="Filtra per rarità">
                    ...
                    <button type="button" data-value="segreto_limited"><strong>Segreto Limited</strong></button>
