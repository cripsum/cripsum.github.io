...
<head>
    ...
    <link rel="stylesheet" href="/assets/inventario/inventario.css?v=2.2-legacy-rarity-anim">
    <script src="/assets/inventario/inventario.js?v=2.2-legacy-rarity-anim" defer></script>
</head>
