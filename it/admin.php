...
<head>
    ...
    <link rel="stylesheet" href="/assets/admin-v2/admin.css?v=2.4">
</head>
...
<body class="admin-v2-body" data-csrf="<?php echo admin_h($csrfToken); ?>" data-admin-id="<?php echo (int)$currentAdmin['id']; ?>" data-admin-role="<?php echo admin_h($currentAdmin['ruolo']); ?>">
    ...
    <main class="admin-shell">
        ...
        <section class="admin-main">
            ...
            <section class="admin-section" id="section-messages" data-section-panel="messages">
                <div class="admin-toolbar">
                    <div>
                        <strong>Centro Messaggi</strong>
                        <small>Invia comunicazioni ufficiali e assegna ricompense agli utenti.</small>
                    </div>
                    <button type="button" class="admin-btn admin-btn--primary" id="sendNewMessageBtn">
                        <i class="fa-solid fa-paper-plane"></i> Nuovo Messaggio
                    </button>
                </div>
            ...
            <section class="admin-section" id="section-tickets" data-section-panel="tickets">
                <div class="admin-toolbar">
                    <div>
                        <strong>Ticket Supporto</strong>
                        <small>Gestisci e rispondi ai ticket di supporto inviati dagli utenti.</small>
                    </div>
                    <div class="admin-toolbar-actions">
    ...
    <script src="/assets/admin-v2/admin.js?v=3.0"></script>
</body>
