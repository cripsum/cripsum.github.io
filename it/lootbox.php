...
<body class="lootbox-page" data-ruolo="<?= htmlspecialchars($ruolo, ENT_QUOTES) ?>">
            ...
            <?php if ($isPremium): ?>
                <div class="gsb-premium-claim-box">
                    ...
                    <button id="premium-claim-btn" class="gsb-premium-claim-btn <?= $hasClaimedToday ? 'claimed' : '' ?>" <?= $hasClaimedToday ? 'disabled' : '' ?>>
                        <span class="btn-text"><?= $hasClaimedToday ? 'Riscattato oggi' : 'Riscatta 500 Punti' ?></span>
                    </button>
                </div>
            <?php endif; ?>
            ...
            premiumBtn.addEventListener('click', async () => {
                try {
                    ...
                    if (data.success) {
                        ...
                        if (btnText) btnText.textContent = 'Riscattato oggi';
    ...
    <script src="/js/gacha.js?v=28"></script>
