...
$downloads = [
    ...
    ['id' => 'vanzakart', 'name' => 'VanzaKart Launcher', 'image' => '../img/vklogo.png', 'alt' => 'VanzaKart Launcher', 'description' => 'Scarica il launcher di VanzaKart per giocare alla mod di Mario Kart Wii più fica di sempre', 'status' => 'available', 'badge' => 'Esterno', 'link' => 'https://sitodaking.it/'],
                            ...
                            <div class="shop-card__footer">
                                ...
                                <div class="shop-card__actions">
                                    ...
                                    <?php if ($item['status'] === 'available'): ?>
                                        <button type="button" class="shop-icon-btn" data-copy-link title="Copia link"><i class="fa-solid fa-link"></i></button>
