...
<head>
    ...
    <link class="profile-css-file" rel="stylesheet" href="/assets/css/profile.css?v=4.6.3">
    <link rel="stylesheet" href="/assets/css/editor-premium.css?v=4.6.3">
    ...
    <script src="/assets/js/profile.js?v=4.6.3" defer></script>
    <script src="/assets/js/edit-profile.js?v=4.6.3" defer></script>
</head>
        ...
        <form id="profileEditForm" class="builder-grid-container" method="post" enctype="multipart/form-data" action="../api/update_profile.php">
            ...
            <div class="editor-sidebar">
                ...
                <div class="editor-sidebar-scroll">
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="effects">
                        <div class="editor-card-header">
                            <div class="editor-card-info">
                                <span class="editor-card-icon"><i class="fas fa-sparkles"></i></span>
                                <div class="editor-card-text">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fas fa-sparkles"></i> Effetti Pagina</span>
            ...
            <div class="editor-preview-pane">
                <div class="preview-toolbar">
                    ...
                    <a href="/u/<?php echo rawurlencode(strtolower($profile['username'])); ?>" target="_blank" class="btn-view-live" title="Apri in una nuova scheda"><i class="fas fa-external-link-alt"></i></a>
                </div>
