...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/photo-cropper.css?v=1.2">
    ...
    <script>
        ...
        /* Quanto accetta il server in un invio. Serve al controllo lato
           browser: senza, un file oltre `post_max_size` partiva comunque, PHP
           scartava tutta la richiesta e tornava un 403 "sessione scaduta" che
    ...
    <script src="/assets/js/photo-cropper.js?v=1.2" defer></script>
    <script src="/assets/js/edit-profile.js?v=5.12.0" defer></script>
</head>
                    ...
                    <div class="plan-option-card is-premium">
                        <div>
                            ...
                            <ul class="plan-features">
                                ...
                                <li><i class="fa-solid fa-check"></i>25.000 Godos inclusi subito</li>
        ...
        <form id="profileEditForm" class="builder-grid-container" method="post" enctype="multipart/form-data" action="../api/update_profile.php">
                ...
                <div class="editor-sidebar-header">
                    <div class="editor-sidebar-brand">
                        ...
                        <div class="editor-header-actions">
                            <button type="button" class="editor-btn editor-btn-icon" id="undoBtn" disabled title="Annulla (Ctrl+Z)"><i class="fa-solid fa-arrow-rotate-left"></i></button>
                            <button type="button" class="editor-btn editor-btn-icon" id="redoBtn" disabled title="Ripristina (Ctrl+Y)"><i class="fa-solid fa-arrow-rotate-right"></i></button>
                            <?php if ((int)($profile['is_premium'] ?? 0) !== 1): ?>
                                <button type="button" class="editor-btn editor-btn-premium" id="headerPremiumBtn"><i class="fa-solid fa-crown"></i> Premium</button>
                            <?php endif; ?>
                            <button type="submit" name="salva" class="editor-btn editor-btn-primary" id="saveBtn"><i class="fa-solid fa-floppy-disk"></i> Salva</button>
                        </div>
                    </div>
                    ...
                    <div class="editor-controls-row">
                        <div class="editor-search-wrapper">
                            ...
                            <input type="text" class="editor-search-input" id="editorSearch" placeholder="Cerca impostazioni (es. foto profilo, colori...)...">
                    ...
                    <div class="editor-tabs-nav">
                        ...
                        <button type="button" class="editor-tab-btn" data-tab="advanced"><i class="fa-solid fa-sliders"></i> Avanzate</button>
                    </div>
                </div>
                ...
                <div class="editor-sidebar-scroll">
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="identity" data-editor-category="profile">
                        <div class="editor-card-header">
                            <div class="editor-card-info">
                                ...
                                <div class="editor-card-text">
                                    <h3>Identità</h3>
                                    <p>Nome visualizzato, bio, foto profilo, musica e tag</p>
                                </div>
                            </div>
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid two">
                                <label class="profile-field"><span>Foto profilo</span><input type="file" name="avatar" id="avatarInput" accept="image/jpeg,image/png,image/webp,image/gif"><small>Max <?php echo profile_format_bytes(profile_effective_upload_limit(($isPremium ? 10 : 2) * 1024 * 1024)); ?>. JPG, PNG, WEBP o GIF.</small></label>
                                <label class="profile-field"><span>Sfondo profilo</span><input type="file" name="banner" id="bannerInput" accept="image/jpeg,image/png,image/webp,image/gif,video/mp4,video/webm"><small>Max <?php echo profile_format_bytes(profile_effective_upload_limit(($isPremium ? 50 : 12) * 1024 * 1024)); ?>. Foto, GIF o video. Cambia lo sfondo della pagina.</small></label>
                            </div>

                            <label class="profile-field"><span>Privacy profilo</span><select name="profile_visibility" id="visibilityInput"><?php foreach (['public' => 'Pubblico', 'logged_in' => 'Solo utenti loggati', 'friends' => 'Solo amici', 'private' => 'Privato'] as $value => $label): ?><option value="<?php echo $value; ?>" <?php echo ($profile['profile_visibility'] ?? 'public') === $value ? 'selected' : ''; ?>><?php echo $label; ?></option><?php endforeach; ?></select></label>

                            <div class="bio-section-heading profile-mt">
                                <div><span><i class="fa-solid fa-music"></i> Audio profilo</span>
                            ...
                            <div class="bio-section-heading profile-mt">
                                <div><span><i class="fa-solid fa-door-open"></i> Click to Enter (Schermata d'ingresso)</span>
                                    <p>Mostra una schermata introduttiva d'ingresso. Utile per fa-regular partire l'audio in automatico.</p>
                                </div>
                            </div>
                            <div class="profile-field-grid two">
                                <label class="profile-toggle-card profile-inline-toggle"><input type="hidden" name="profile_click_to_enter" value="0"><input type="checkbox" name="profile_click_to_enter" value="1" <?php echo (int)($profile['profile_click_to_enter'] ?? 0) === 1 ? 'checked' : ''; ?> id="clickToEnterInput"><span><i class="fa-solid fa-hand-pointer"></i>Abilita Click to Enter</span></label>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="tags" data-editor-category="profile">
                        <div class="editor-card-header">
                            <div class="editor-card-info">
                                ...
                                <div class="editor-card-text">
                                    <h3>Tag / Pills Personalizzate</h3>
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-tags"></i> Gestione Tag</span>
                                    <p>Aggiungi pillole colorate sotto la tua biografia (max 10).</p>
                                </div>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="design" data-editor-category="design">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-presets-block" style="margin-bottom: 1.5rem;">
                                <span><i class="fa-solid fa-magic"></i> Temi Premium (Un-click per applicare) <span class="premium-badge-tag"><i class="fa-solid fa-crown"></i> Premium</span></span>
                            ...
                            <div class="profile-presets-block">
                                <span><i class="fa-solid fa-palette"></i> Palette Colore Veloci</span>
                            ...
                            <div class="bio-section-heading profile-mt">
                                <div><span><i class="fa-solid fa-sliders"></i> Opzioni Layout e Colori</span></div>
                            </div>
                            <div class="profile-field-grid three">
                                ...
                                <label class="profile-field"><span>Layout</span>
                                    <select id="layoutInput">
                                        ...
                                        $layoutOptions = [
                                            ...
                                            'showcase' => 'Profilo destra, tab sinistra',
                                            'clean' => 'Tutto centrale in colonna',
                                            'scrollsnap' => 'Layout a scorrimento verticale (Scroll Snap)'
                                        ];
                                ...
                                <label class="profile-field"><span>Stile del player musicale</span><select name="profile_music_theme" id="musicThemeInput">
                                        <option value="default" <?php echo ($profile['profile_music_theme'] ?? 'default') === 'default' ? 'selected' : ''; ?>>Default</option>
                                        <option value="retro" <?php echo ($profile['profile_music_theme'] ?? 'default') === 'retro' ? 'selected' : ''; ?> data-premium="1">Compatto (Riga)</option>
                                        <option value="cyberpunk" <?php echo ($profile['profile_music_theme'] ?? 'default') === 'cyberpunk' ? 'selected' : ''; ?> data-premium="1">Pillola Centrata</option>
                                        <option value="synthwave" <?php echo ($profile['profile_music_theme'] ?? 'default') === 'synthwave' ? 'selected' : ''; ?> data-premium="1">Vinyl Player (Disco)</option>
                                    </select></label>
                            ...
                            <div class="bio-section-heading profile-mt">
                                <div><span><i class="fa-solid fa-wand-magic-sparkles"></i> Forme, Bordi e Trasparenze</span></div>
                            </div>
                            <div class="profile-field-grid two">
                                ...
                                <label class="profile-field"><span>Forma foto profilo</span><select name="profile_avatar_shape" id="avatarShapeInput">
                                ...
                                <label class="profile-field"><span>Stile Bordi Card e Pulsanti</span><select name="profile_border_style" id="borderStyleInput">
                                        <?php foreach (['none' => 'Nessun Bordo', 'thin' => 'Bordo Sottile', 'glow' => 'Bordo Glow (Bagliore)', 'gradient' => 'Bordo Gradiente'] as $val => $lbl): ?>
                            ...
                            <div class="bio-section-heading profile-mt">
                                <div><span><i class="fa-solid fa-image"></i> Personalizzazione Sfondo</span></div>
                            </div>
                            <div class="profile-field-grid three">
                            ...
                            <div style="margin-top: 1.5rem; display: flex; justify-content: flex-end; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 1.5rem;">
                                <button type="button" id="resetDesignBtn" class="bio-button" style="background: rgba(239, 68, 68, 0.15); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.25); display: flex; align-items: center; gap: 0.5rem; padding: 0.6rem 1.2rem; border-radius: 12px; font-weight: 700; cursor: pointer; transition: all 0.2s; font-size: 0.9rem;">
                                    <i class="fa-solid fa-arrow-rotate-left"></i> Ripristina valori di default
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="editor-card-body">
                            <div class="profile-discord-connect-card">
                                <div class="profile-discord-connect-main">
                                    <?php if ($discordConnected): ?>
                                        <?php if ($discordAvatarUrl): ?><img src="<?php echo profile_h($discordAvatarUrl); ?>" alt="" loading="lazy" data-live-discord-avatar data-discord-id="<?php echo profile_h($profile['discord_id']); ?>" data-avatar-size="128"><?php else: ?><span class="profile-discord-avatar-fallback"><i class="fa-brands fa-discord"></i></span><?php endif; ?>
                                        <div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div>
                                            ...
                                            <small>Collega Discord per salvare ID, username e foto profilo.</small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="profile-discord-actions">
                                    <a class="bio-button bio-button--primary" href="<?php echo profile_h($connectDiscordUrl); ?>"><i class="fa-brands fa-discord"></i><?php echo $discordConnected ? 'Ricollega' : 'Collega Discord'; ?></a>
                                    <?php if ($discordConnected): ?>
                                        <button class="bio-button profile-discord-disconnect" type="submit" form="disconnectDiscordForm"><i class="fa-solid fa-link-slash"></i>Scollega</button>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="bio-section-heading" style="margin-top: 2rem; border-top: 1px solid rgba(255,255,255,0.06); padding-top: 1.5rem;">
                                <div><span><i class="fa-brands fa-discord"></i> Server Discord</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="links" data-editor-category="profile">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="bio-section-heading profile-mt">
                                <div><span><i class="fa-solid fa-star"></i> Link personalizzati</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="projects" data-editor-category="profile">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-cubes"></i> Progetti</span></div>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="content" data-editor-category="profile">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-circle-play"></i> Contenuti</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="custom" data-editor-category="advanced">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-wand-magic-sparkles"></i> Blocchi custom</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="effects" data-editor-category="design">
                        <div class="editor-card-header">
                            <div class="editor-card-info">
                                ...
                                <div class="editor-card-text">
                                    ...
                                    <p>Effetti pagina, anello della foto profilo, colori nome, tilt e scheda browser</p>
                                </div>
                            </div>
                            <div class="editor-card-actions">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-magic"></i> Effetti Pagina</span>
                            ...
                            <div class="profile-field-grid three">
                                <label class="profile-field"><span>Effetto pagina</span><select name="profile_effect" id="profileEffectInput">
                                        ...
                                        <?php endforeach; ?>
                                    </select><small id="glassRainWarning" class="profile-effect-warning" style="display:<?php echo ($profile['profile_effect'] ?? 'none') === 'glass_rain' ? 'flex' : 'none'; ?>"><i class="fa-solid fa-circle-info"></i> Glass rain supporta solo sfondi statici (immagini).</small></label>
                            ...
                            <div class="profile-effect-hint" style="margin: 0.5rem 0 1rem 0;">
                                <span><i class="fa-solid fa-circle-info"></i> Il colore dell’anello viene applicato nel profilo pubblico.</span>
                            </div>
                            ...
                            <label class="profile-toggle-card profile-inline-toggle"><input type="hidden" name="profile_avatar_border" value="0"><input type="checkbox" name="profile_avatar_border" id="avatarBorderInput" value="1" <?php echo (int)($profile['profile_avatar_border'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-border-style"></i>Mostra bordo della foto profilo</span></label>

                            <div class="bio-section-heading" style="margin-top: 1.8rem; border-top: 1px dashed rgba(255, 255, 255, 0.08); padding-top: 1.5rem;">
                                <div><span><i class="fa-solid fa-mouse-pointer"></i> Personalizzazione Cursore</span>
                                    <p>Impostazioni per il puntatore e l'effetto cursore del profilo.</p>
                                </div>
                            </div>
                            <div class="profile-field-grid three">
                                <label class="profile-field"><span>Effetto Cursore</span><select name="profile_cursor_effect" id="cursorEffectInput">
                                        <option value="none" <?php echo ($profile['profile_cursor_effect'] ?? 'none') === 'none' ? 'selected' : ''; ?>>Nessuno</option>
                                        <option value="follower" <?php echo ($profile['profile_cursor_effect'] ?? 'none') === 'follower' ? 'selected' : ''; ?> data-premium="1">Follower dot (Puntatore)</option>
                                        <option value="trail" <?php echo ($profile['profile_cursor_effect'] ?? 'none') === 'trail' ? 'selected' : ''; ?> data-premium="1">Scia particelle (Trail)</option>
                                        <option value="trail_stars" <?php echo ($profile['profile_cursor_effect'] ?? 'none') === 'trail_stars' ? 'selected' : ''; ?> data-premium="1">Stelline (Trail Stars)</option>
                                        <option value="cat_follower" <?php echo ($profile['profile_cursor_effect'] ?? 'none') === 'cat_follower' ? 'selected' : ''; ?> data-premium="1">Gattino (Cat Follower)</option>
                                        <option value="trail_hearts" <?php echo ($profile['profile_cursor_effect'] ?? 'none') === 'trail_hearts' ? 'selected' : ''; ?> data-premium="1">Cuoricini (Trail Hearts)</option>
                                    </select></label>

                                <label class="profile-field"><span>Cursore Personalizzato (Immagine) <span class="premium-badge-tag"><i class="fa-solid fa-crown"></i> Premium</span></span>
                            ...
                            <div class="profile-field-grid three" style="margin-top: 1rem;">
                                ...
                                <label class="profile-field"><span>Cursore Hover Link (Immagine) <span class="premium-badge-tag"><i class="fa-solid fa-crown"></i> Premium</span></span>
                                    <div class="input-with-upload">
                                        <input type="text" name="profile_cursor_custom_hover_url" id="cursorCustomHoverUrlInput" value="<?php echo profile_h($profile['profile_cursor_custom_hover_url'] ?? ''); ?>" placeholder="/uploads/... o url">
                                    ...
                                    <small style="opacity: 0.7; font-size: 0.75rem; margin-top: 4px; display: block;">PNG, JPG, WEBP, GIF, CUR, ANI. Usato quando passi sopra i link.</small>
                                </label>
                                ...
                                <div class="profile-field" style="display: flex; flex-direction: column; justify-content: flex-end; height: 100%;">
                                    <label class="profile-toggle-card profile-inline-toggle" style="margin: 0; width: 100%;">
                                        ...
                                        <span><i class="fa-solid fa-crosshairs"></i>Centra Hover</span>
                                    </label>
                                </div>
                            </div>

                            <div class="bio-section-heading" style="margin-top: 1.8rem; border-top: 1px dashed rgba(255, 255, 255, 0.08); padding-top: 1.5rem;">
                                <div><span><i class="fa-solid fa-signature"></i> Personalizzazione Nome</span>
                            ...
                            ?>
                            <div class="bio-section-heading" style="margin-top: 1.8rem; border-top: 1px dashed rgba(255, 255, 255, 0.08); padding-top: 1.5rem;">
                                <div><span><i class="fa-solid fa-cube"></i> Effetto Inclinazione (Tilt Card)</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="badges" data-editor-category="profile">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-trophy"></i> Badge visibili</span>
                                    <?php if ($isPremium): ?>
                                        <p>Scegli quali badge mostrare sul tuo profilo (<strong>illimitati</strong> con il tuo piano Premium) e ordinali.</p>
                                    <?php else: ?>
                                        <p>Scegli quali badge mostrare sul tuo profilo (massimo 8 - <strong>illimitati</strong> con <a href="/it/shop.php" style="color: var(--accent); text-decoration: underline;">Premium</a>) e ordinali.</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="editor-card-body">
                            <?php if ($inventoryCharacters): ?>
                                ...
                                <div class="profile-character-sort-section" style="margin-top: 1.5rem;">
                                    <strong style="display: block; margin-bottom: 0.5rem;"><i class="fa-solid fa-sort"></i> Ordinamento Personaggi Selezionati</strong>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="tab-title" data-editor-category="advanced">
                        <div class="editor-card-header">
                            <div class="editor-card-info">
                                ...
                                <div class="editor-card-text">
                                    <h3>Titolo Scheda Browser (Tab)</h3>
                                    <p>Titolo del browser ed effetti di animazione per la scheda</p>
                                </div>
                            </div>
                            <div class="editor-card-actions">
                                <span class="editor-status-badge is-active">Configurato</span>
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-window-maximize"></i> Titolo Scheda Browser</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="visibility" data-editor-category="advanced">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-eye"></i> Sezioni pubbliche</span>
                            ...
                            <div class="profile-toggle-grid">
                                ...
                                <label class="profile-toggle-card"><input type="hidden" name="profile_show_links" value="0"><input type="checkbox" name="profile_show_links" value="1" <?php echo (int)($profile['profile_show_links'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-link"></i>Link</span></label>
                                <label class="profile-toggle-card"><input type="hidden" name="profile_show_embeds" value="0"><input type="checkbox" name="profile_show_embeds" value="1" <?php echo (int)($profile['profile_show_embeds'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-share-from-square"></i>Embed</span></label>
                                <label class="profile-toggle-card"><input type="hidden" name="profile_show_projects" value="0"><input type="checkbox" name="profile_show_projects" value="1" <?php echo (int)($profile['profile_show_projects'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-cubes"></i>Progetti</span></label>
                                <label class="profile-toggle-card"><input type="hidden" name="profile_show_contents" value="0"><input type="checkbox" name="profile_show_contents" value="1" <?php echo (int)($profile['profile_show_contents'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-play"></i>Edit e contenuti</span></label>
                                <label class="profile-toggle-card"><input type="hidden" name="profile_show_blocks" value="0"><input type="checkbox" name="profile_show_blocks" value="1" <?php echo (int)($profile['profile_show_blocks'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-wand-magic-sparkles"></i>Blocchi Custom</span></label>
                                <label class="profile-toggle-card"><input type="hidden" name="profile_show_badges" value="0"><input type="checkbox" name="profile_show_badges" value="1" <?php echo (int)($profile['profile_show_badges'] ?? 1) === 1 ? 'checked' : ''; ?>><span><i class="fa-solid fa-trophy"></i>Badge</span></label>
                                <label class="profile-toggle-card">
                                    ...
                                    <span><i class="fa-solid fa-user-astronaut"></i>Personaggi</span>
                                </label>
                            ...
                            <div style="margin-top: 1.25rem; width: 100%; display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                <label class="profile-field" style="display: flex; flex-direction: column; gap: 0.4rem; width: 100%;">
                                    <span style="font-size: 0.82rem; font-weight: 600; color: var(--muted);"><i class="fa-solid fa-trophy"></i> Visualizzazione Badge</span>
                                ...
                                <label class="profile-field" style="display: flex; flex-direction: column; gap: 0.4rem; width: 100%;">
                                    <span style="font-size: 0.82rem; font-weight: 600; color: var(--muted);"><i class="fa-solid fa-location-arrow"></i> Posizione dei mini-badge</span>
                            ...
                            <div class="bio-section-heading" style="margin-top: 1.8rem;">
                                <div><span><i class="fa-solid fa-sort"></i> Ordinamento sezioni</span>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="presets" data-editor-category="advanced">
                        ...
                        <div class="editor-card-body">
                            <div class="bio-section-heading">
                                <div><span><i class="fa-solid fa-magic"></i> Preset del Profilo</span>
                                    <p>Salva e carica configurazioni complete del tuo profilo (massimo 5 preset).</p>
                                </div>
                                <button type="button" class="bio-button" id="saveNewPresetBtn"><i class="fa-solid fa-plus"></i> Salva Preset Corrente</button>
                            </div>
            ...
            <div class="editor-preview-pane">
                <div class="preview-toolbar">
                    ...
                    <a href="/u/<?php echo rawurlencode(strtolower($profile['username'])); ?>" target="_blank" class="btn-view-live" title="Apri in una nuova scheda"><i class="fa-solid fa-up-right-from-square"></i> Vedi profilo</a>
                </div>
