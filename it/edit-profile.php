...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/editor-premium.css?v=5.10.0">
    ...
    <script src="/assets/js/edit-profile.js?v=5.10.0" defer></script>
</head>
                    ...
                    <div class="plan-option-card is-premium">
                        <div>
                            ...
                            <ul class="plan-features">
                                ...
                                <li><i class="fa-solid fa-check"></i>20.000 Godos inclusi subito</li>
