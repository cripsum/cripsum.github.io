...
<head>
    ...
    <link class="profile-css-file" rel="stylesheet" href="/assets/css/profile.css?v=4.0.6">
    ...
    <script src="/assets/js/profile.js?v=4.0.6" defer></script>
    <script src="/assets/js/edit-profile.js?v=4.0.5" defer></script>
</head>
