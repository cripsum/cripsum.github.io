...
<head>
    ...
    <link class="profile-css-file" rel="stylesheet" href="/assets/css/profile.css?v=5.9.1">
    <link rel="stylesheet" href="/assets/css/editor-premium.css?v=5.9.1">
    ...
    <script src="/assets/js/profile.js?v=5.9.1" defer></script>
    <script src="/assets/js/edit-profile.js?v=5.9.1" defer></script>
</head>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="effects" data-editor-category="design">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid three">
                                ...
                                <label class="profile-field"><span>Cursore Personalizzato (Immagine)</span>
