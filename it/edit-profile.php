...
<head>
    ...
    <script src="/assets/js/edit-profile.js?v=4.8.8" defer></script>
</head>
                    ...
                    <div class="profile-edit-section editor-card" data-edit-section="design">
                        ...
                        <div class="editor-card-body">
                            ...
                            <div class="profile-field-grid three">
                                ...
                                <label class="profile-field"><span>Stile link</span><select name="profile_link_style" id="linkStyleInput"><?php foreach (['glass' => 'Glass', 'solid' => 'Pieno', 'outline' => 'Outline', 'neon' => 'Neon', 'minimal' => 'Minimale', 'gradient' => 'Gradiente'] as $value => $label): ?><option value="<?php echo $value; ?>" <?php echo $linkStyle === $value ? 'selected' : ''; ?>><?php echo $label; ?></option><?php endforeach; ?></select></label>
