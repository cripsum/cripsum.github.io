    ...
    <main class="game-shell game-arena-shell">
        ...
        <section class="game-arena" id="arenaPanel" hidden>
            ...
            <div class="game-action-bar" id="actionBar" aria-label="Azioni battaglia">
                ...
                <button class="game-move game-move-ultimate" data-battle-action="ultimate" type="button" style="display:none;"><i class="fa-solid fa-bolt"></i><strong>Ultimate</strong><span>Mossa finale devastante</span></button>
            </div>
