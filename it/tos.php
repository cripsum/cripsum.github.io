    ...
    <main class="static-shell">
        ...
        <div class="static-layout">
            <aside class="static-toc static-reveal">
                ...
                <a href="#natura">2. Natura del Servizio</a>
                <a href="#eta">3. Requisiti di età</a>
                <a href="#account">4. Registrazione e Sicurezza</a>
                <a href="#discord">5. Collegamento Discord</a>
                <a href="#pagamenti">6. Pagamenti e Valute Virtuali</a>
                <a href="#premium">7. Abbonamento Premium</a>
                <a href="#giochi">8. Gacha, Lootbox e Duelli</a>
                <a href="#contenuti">9. Contenuti dell'Utente (Shitpost)</a>
                <a href="#ticket">10. Ticket di Supporto e Chat</a>
                <a href="#moderazione">11. Sospensione e Terminazione</a>
                <a href="#responsabilita">12. Limitazione di Responsabilità</a>
                <a href="#manleva">13. Clausola di Manleva</a>
                <a href="#modifiche">14. Modifiche ai Termini</a>
            ...
            <div class="static-content">
                ...
                <section class="static-legal-section static-reveal" id="natura">
                    <h2>2. Natura del Servizio e Scopo Ricreativo</h2>
                    <p>Cripsum™ è un progetto personale creato e gestito a scopo ricreativo, umoristico e di intrattenimento. La Piattaforma contiene meme, elementi di ironia, citazioni e riferimenti interni che non devono essere presi in senso serio o letterale.</p>
                    <p>Fatto salvo per gli acquisti reali di Godo Shards e dello status Premium esplicitamente processati tramite il circuito PayPal, eventuali altre simulazioni di shop o meccaniche presenti sul sito hanno solo scopo di gioco. Eventuali donazioni monetarie dirette a supporto del progetto sono reali, volontarie e non rimborsabili.</p>
                    <p>A scopo di trasparenza, parte del codice sorgente del frontend del sito è reso pubblico sul repository ufficiale GitHub all'indirizzo <a href="https://github.com/cripsum/cripsum.github.io" target="_blank" rel="noopener">github.com/cripsum/cripsum.github.io</a>.</p>
                </section>

                <section class="static-legal-section static-reveal" id="eta">
                    <h2>3. Requisiti di età</h2>
                ...
                <section class="static-legal-section static-reveal" id="discord">
                    <h2>5. Collegamento Discord e Bot di Presenza</h2>
                ...
                <section class="static-legal-section static-reveal" id="pagamenti">
                    <h2>6. Pagamenti, Acquisti e Valute Virtuali</h2>
                ...
                <section class="static-legal-section static-reveal" id="giochi">
                    <h2>8. Gacha, Lootbox e Duelli (Meccaniche di Gioco)</h2>
                ...
                <section class="static-legal-section static-reveal" id="contenuti">
                    <h2>9. Contenuti dell'Utente e Moderazione (Shitpost)</h2>
                ...
                <section class="static-legal-section static-reveal" id="ticket">
                    <h2>10. Ticket di Supporto e Chat</h2>
                ...
                <section class="static-legal-section static-reveal" id="moderazione">
                    <h2>11. Sospensione e Terminazione dell'Account (Ban)</h2>
